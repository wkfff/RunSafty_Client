...
type
  PSP_DEVICE_INTERFACE_DETAIL_DATA_A = ^TSPDeviceInterfaceDetailDataA;
  PSP_DEVICE_INTERFACE_DETAIL_DATA_W = ^TSPDeviceInterfaceDetailDataW;
  PSP_DEVICE_INTERFACE_DETAIL_DATA = ^TSPDeviceInterfaceDetailDataA;
  PSPDeviceInterfaceDetailDataA = PSP_DEVICE_INTERFACE_DETAIL_DATA_A;
  PSPDeviceInterfaceDetailDataW = PSP_DEVICE_INTERFACE_DETAIL_DATA_W;
  PSPDeviceInterfaceDetailData  = PSP_DEVICE_INTERFACE_DETAIL_DATA;
...
const
  ...
  SPDRP_DEVICE_POWER_DATA           = $0000001E; // UiNumberDescFormat (R/W)
  {$EXTERNALSYM SPDRP_UI_NUMBER_DESC_FORMAT}
  SPDRP_REMOVAL_POLICY              = $0000001F; // Upper bound on ordinals
