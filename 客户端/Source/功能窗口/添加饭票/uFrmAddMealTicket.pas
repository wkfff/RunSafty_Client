...
begin
  ...
  Ticket.userid := GlobalDM.DutyUser.strDutyNumber;
  Ticket.userName := GlobalDM.DutyUser.strDutyName;
...
begin
  if not TMealCfg.ManualSend[GlobalDM.SiteInfo.WorkShopGUID] then
  begin
