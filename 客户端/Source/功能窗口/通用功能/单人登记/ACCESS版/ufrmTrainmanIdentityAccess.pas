...
uses
  ...
  PngSpeedButton, pngimage, RzPanel,uTrainPlan,ufrmTextInput,ZKFPEngXControl_TLB,
  utfsystem,uSaftyEnum,uTrainman,uBaseDBRoomSign,uDBAccessRoomSign;
...
begin
  ...
  if GlobalDM.m_blnIsLocalMode then
  begin
