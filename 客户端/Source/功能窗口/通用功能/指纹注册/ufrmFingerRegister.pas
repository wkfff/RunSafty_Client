...
begin
  ...
  try
    ...
    frmFingerRegister.m_ZKFPEng := GlobalDM.FingerPrintCtl.ZKFPEngX;
    GlobalDM.FingerPrintCtl.ZKFPEngX.OnImageReceived := frmFingerRegister.OnZKFPEngXOnImageReceived;
    GlobalDM.FingerPrintCtl.ZKFPEngX.OnFeatureInfo := frmFingerRegister.OnZKFPEngFeatureInfo;
    GlobalDM.FingerPrintCtl.ZKFPEngX.OnEnroll := frmFingerRegister.OnZKFPEngEnroll;
    GlobalDM.FingerPrintCtl.ZKFPEngX.CancelEnroll;
    if DefaultOne then
