...
begin
  ...
  m_DBCallNotify.SetRecv(strGUIDAry,GlobalDM.LogUserInfo.strDutyUserName,GlobalDM.GetNow);
...
begin
  ...
  begin
    box(Format('房间[%s]不存在!',[strNewRoom]));
    Exit;
  end;
...
begin
  ...
  m_DBCallNotify.SetCancel(callNotify.strMsgGUID,GlobalDM.LogUserInfo.strDutyUserName,
