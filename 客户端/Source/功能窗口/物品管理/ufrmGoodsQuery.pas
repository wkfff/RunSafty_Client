...
uses
  ...
  uGlobalDM, ComCtrls, RzListVw,uTFSystem, RzEdit, RzLstBox, RzBckgnd,
...
begin
  ...
  try
    ...
    DetailsQueryCondition.WorkShopGUID := GlobalDM.SiteInfo.WorkShopGUID;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        m_RsLCGoodsMgr.DeleteGoods(nLendingType,strLendingExInfo,GlobalDM.SiteInfo.WorkShopGUID);
      end;
    end;
    btnQuery.Click;
...
begin
  Condition := TRsDetailsQueryCondition.Create;
  try
    Condition.WorkShopGUID := GlobalDM.SiteInfo.WorkShopGUID;
...
var
  ...
  Item: TListItem;
begin
  m_RsLCGoodsMgr.GetTongJiInfo(m_lendingToJiList,GlobalDM.SiteInfo.WorkShopGUID);
...
begin
  ...
  m_RsLCGoodsMgr.QueryGoodsNow(GlobalDM.SiteInfo.WorkShopGUID,
    DetailsQueryCondition.nLendingType,
    DetailsQueryCondition.nBianHao,
    orderType,
