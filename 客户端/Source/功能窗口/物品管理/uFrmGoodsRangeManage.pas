...
begin
  ...
  GoodsRange.strWorkShopGUID := GlobalDM.SiteInfo.WorkShopGUID ;
...
begin
  ...
  m_RsLCGoodsMgr.CodeRange.Get(GlobalDM.SiteInfo.WorkShopGUID,StrToIntDef(strType,-1),m_ListGoodsRange);
