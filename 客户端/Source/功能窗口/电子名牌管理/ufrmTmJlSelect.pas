...
uses
  ...
  uDutyPlace,uLCNameBoardEx,uTFSystem;
...
begin
  m_RsLCTogetherPlate := TRsLCTogetherPlate.Create(GlobalDM.WebAPIUtils);
end;
...
begin
  ...
  RsLCBaseDict.LCTrainmanJiaolu.GetTMJLByTrainJLWithSiteVirtual(GlobalDM.SiteInfo.strSiteGUID,'',m_JiaoluArray);
