...
uses
  ...
  uLCTrainmanMgr,Forms,comobj,uFrmProgressEx;
const
...
begin
  ...
  try
    ...
    begin
      ...
      TfrmProgressEx.ShowProgress('正在导出信息，请稍后',i + 1,length(namedGroupArray));
    end;
...
begin
  ...
  jltNamed :
    begin
      ImportNamedGroups(TrainmanJiaolu,FileName);
    end;
  jltOrder :
    begin
...
begin
  ...
  try
    ...
    InputDelTm.DutyUser.strDutyGUID := GlobalDM.DutyUser.strDutyGUID;
    InputDelTm.DutyUser.strDutyNumber := GlobalDM.DutyUser.strDutyNumber;
    InputDelTm.DutyUser.strDutyName := GlobalDM.DutyUser.strDutyName;
    ...
    NamedGrpInputParam.DutyUser.strDutyGUID := GlobalDM.DutyUser.strDutyGUID;
    NamedGrpInputParam.DutyUser.strDutyNumber := GlobalDM.DutyUser.strDutyNumber;
    NamedGrpInputParam.DutyUser.strDutyName := GlobalDM.DutyUser.strDutyName;
    ...
    begin
     //收集数据
      ...
      TfrmProgressEx.ShowProgress('正在导入交路信息，请稍后',nIndex - 1,nTotalCount);
    end;
  finally
    TfrmProgressEx.CloseProgress;
    excelApp.Quit;
