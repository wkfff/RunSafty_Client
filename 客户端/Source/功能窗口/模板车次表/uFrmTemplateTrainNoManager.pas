...
type
  ...
  public
    { Public declarations }
    class procedure ManageTemplateTrainNo;
  end;
...
uses
  uGlobalDM,uFrmTemeplateTrainNoGroup,
...
begin
  ...
  try
    ...
    TFrmTemeplateTrainNoGroup.Edit(DayPlan,DayPlanItemGroup,True);
  finally
    DayPlan.Free ;
...
begin
  ...
  try
    DayPlan.ID := nSelDayPlanID;
    DayPlan.Name := cmbDayPlan.Text;
    TFrmTemeplateTrainNoGroup.Edit(DayPlan,DayPlanItemGroup,False);
  finally
    DayPlan.Free ;
    DayPlanItemGroup.Free ;
    InitGroup ;
...
begin
  ...
  try
    if  DayPlanItemGroup.IsDaWen = 0 then
      TFrmTemeplateTrainNoItem.Edit(DayPlan.Name,DayPlanItemGroup.Name,DayPlanItem,True)
    else
      TFrmTemeplateDaWenItem.Edit(DayPlan.Name,DayPlanItemGroup.Name,DayPlanItem,True);
  finally
    DayPlan.Free ;
    DayPlanItemGroup.Free;
    DayPlanItem.Free ;
...
begin
  ...
  try
    if  DayPlanItemGroup.IsDaWen = 0 then
      TFrmTemeplateTrainNoItem.Edit(DayPlan.Name,DayPlanItemGroup.Name,DayPlanItem,False)
    else
      TFrmTemeplateDaWenItem.Edit(DayPlan.Name,DayPlanItemGroup.Name,DayPlanItem,False) ;
  finally
    DayPlan.Free ;
    DayPlanItemGroup.Free;
    DayPlanItem.Free ;
...
begin
  ...
  m_LCDayTemplate := TRsLCDayTemplate.Create(GlobalDM.WebAPIUtils);
...
class procedure TTemplateTrainNoManager.ManageTemplateTrainNo;
var
  TemplateTrainNoManager : TTemplateTrainNoManager ;
begin
