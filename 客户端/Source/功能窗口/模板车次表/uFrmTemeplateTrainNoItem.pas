...
type
  ...
  public
    { Public declarations }
    class procedure Edit(DayPlanInfo,PlanGroupInfo:string;DayPlanItem:TRsDayPlanItem;IsAdd:Boolean);
  end;
...
class procedure TFrmTemeplateTrainNoItem.Edit(DayPlanInfo,PlanGroupInfo:string;DayPlanItem:TRsDayPlanItem;IsAdd:Boolean);
var
...
procedure TFrmTemeplateTrainNoItem.FormCreate(Sender: TObject);
begin
