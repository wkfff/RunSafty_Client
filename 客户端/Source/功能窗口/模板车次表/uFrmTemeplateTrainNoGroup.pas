...
type
  ...
  public
    { Public declarations }
    class procedure Edit(DayPlan:TRsDayPlan;DayPlanItemGroup:TRsDayPlanItemGroup;IsAdd:Boolean=True);
  end;
...
class procedure TFrmTemeplateTrainNoGroup.Edit( DayPlan:TRsDayPlan;
...
procedure TFrmTemeplateTrainNoGroup.FormCreate(Sender: TObject);
begin
