...
uses
  ...
  ,uUPDateThread,uTFMessageDefine,uTFMessageComponent,uTrainman,uTrainPlan,
  uRunSaftyMessageDefine,uWaitWorkMgr,uWaitWork,uWebIF,superobject,
  uTFSystem,ufrmReadFingerprintTemplates,uDBAccessRoomSign;
      ...
      case TFMessages.Items[i].msg of
        ...
        begin
          ...
          case TFMessages.Items[i].msg of
            ...
            //TFM_PLAN_WAITWORK_PUBLISH: ePlanType := TWWPT_ASSIGN;
          end;
