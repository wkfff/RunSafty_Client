...
begin
  ...
  begin
    ...
    TuiQinTimeLog.strDutyUserName := FieldByName('strDubyUserName').AsString;
...
begin
  ...
  begin
     ...
     FieldByName('strDubyUserName').AsString := TuiQinTimeLog.strDutyUserName;
